...
function Au(u: f64[], v: f64[], n: i32): i32 {
  for (let i: i32 = 0; i < n; ++i) {
    ...
    for (let j: i32 = 0; j < n; ++j)
      t +=
        (function (arg0: i32, arg1: i32): f64 {
          ...
          return apply2Args<f64, i32, i32>("A", changetype<usize>(A), args);
        })(i, j) * u[j];
    v[i] = t;
  }
  return 1;
...
export function main(): i32 {
  ...
  for (let i: i32 = 6; i <= 48; i *= 2) {
    sum =
      sum +
      ((function (arg0: i32): f64 {
        var args = new ArgsBuffer([sizeof<i32>()]);
        args.setArgument<i32>(0, Types.i32, arg0, 0);
        return apply1Args<f64, i32>(
          "spectralnorm",
          changetype<usize>(spectralnorm),
          args
        );
      })(i) as i32);
  }
...
function spectralnorm(n: i32): f64 {
  ...
  for (i = 0; i < 10; ++i) {
    (function (arg0: f64[], arg1: f64[], arg2: i32): i32 {
      var args = new ArgsBuffer([
        sizeof<f64[]>(),
        sizeof<f64[]>(),
        sizeof<i32>(),
      ]);
      args.setArgument<f64[]>(0, Types.classInstance, arg0, idof<f64[]>());
      args.setArgument<f64[]>(1, Types.classInstance, arg1, idof<f64[]>());
      args.setArgument<i32>(2, Types.i32, arg2, 0);
      return apply3Args<i32, f64[], f64[], i32>(
        "Au",
        changetype<usize>(Au),
        args
      );
